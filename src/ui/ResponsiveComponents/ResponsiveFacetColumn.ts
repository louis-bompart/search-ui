...
export class ResponsiveDropdownBuilder {
  ...
  public static DefaultClass: typeof ResponsiveDropdownBuilder = ResponsiveDropdownBuilder;
  public static doExport = () => {
    exportGlobally({
      ResponsiveDropdownBuilder: ResponsiveDropdownBuilder
    });
  };

  constructor(private coveoRoot, private dropdownHeaderLabel) {}

  public buildDropdown(responsiveDropdown?: ResponsiveDropdown) {
  ...
  protected buildDropdownContent(): ResponsiveDropdownContent {
    ...
    let dropdownContent = new ResponsiveDropdownContent(
      ...
      this.coveoRoot,
      ResponsiveDropdownBuilder.DROPDOWN_MIN_WIDTH,
      ResponsiveDropdownBuilder.DROPDOWN_WIDTH_RATIO
    );
    return dropdownContent;
  }

  protected buildDropdownHeader(): ResponsiveDropdownHeader {
...
export class ResponsiveFacetColumn implements IResponsiveComponent {
  ...
  constructor(public coveoRoot: Dom, public ID: string, options: IResponsiveComponentOptions, responsiveDropdown?: ResponsiveDropdown) {
    ...
    const responsiveDropdownBuilder = new ResponsiveDropdownBuilder.DefaultClass(coveoRoot, this.dropdownHeaderLabel);
    this.dropdown = responsiveDropdownBuilder.buildDropdown(responsiveDropdown);
